...
namespace Day7
{
    ...
    class Program
    {
        static Dictionary<string, ushort> Simulate(List<Gate> gates, Dictionary<string, ushort> knownSignals)
        {
            ...
            while (unknownSeen)
            {
                ...
                foreach (var g in gates)
                {
                    ...
                    {
                        // already been executed -> skipping
                        continue;
                    }
        ...
        static void Main(string[] args)
        {
            ...
            knownSignals = Simulate(gates, knownSignals);
